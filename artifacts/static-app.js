...
// EXTERNAL MODULE: /home/djtran/Workspace/chunky-parrot/src/components/Router.js
var Router = __webpack_require__(4);

// CONCATENATED MODULE: /home/djtran/Workspace/chunky-parrot/src/containers/Dynamic.js
...
function App() {
  return /*#__PURE__*/external_react_default.a.createElement(external_react_static_["Root"], null, /*#__PURE__*/external_react_default.a.createElement(external_react_static_["Head"], null, /*#__PURE__*/external_react_default.a.createElement("link", {
    ...
    to: "/index"
  }, "Index")), /*#__PURE__*/external_react_default.a.createElement("div", {
    className: "content"
...
module.exports = require("/home/djtran/Workspace/chunky-parrot/node_modules/react-static/lib/browser");
...
function Home() {
  var _useSiteData = Object(react_static__WEBPACK_IMPORTED_MODULE_1__["useSiteData"])(),
      workflowDirectory = _useSiteData.workflowDirectory;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WorkflowIndex; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
function WorkflowIndex() {
  var _useRouteData = Object(react_static__WEBPACK_IMPORTED_MODULE_2__["useRouteData"])(),
      wfiles = _useRouteData.wfiles;

  console.log(wfiles);
  wfiles.map(function (workflow) {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, " Workflows "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
    className: "no-bullets"
  }, wfiles.map(function (workflow) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(components_Router__WEBPACK_IMPORTED_MODULE_1__[/* Link */ "a"], {
      to: "/index/workflow/".concat(workflow.title.replace(/\s/g, '-'))
    }, workflow.title));
  })));
}
...
var assertThisInitialized_ = __webpack_require__(5);
...
// CONCATENATED MODULE: /home/djtran/Workspace/chunky-parrot/src/components/Slide.js
...
var Slide_Slide = /*#__PURE__*/function (_React$Component) {
  inherits_default()(Slide, _React$Component);
  ...
  function Slide(props) {
    ...
    classCallCheck_default()(this, Slide);
  ...
  createClass_default()(Slide, [{
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/external_react_default.a.createElement("div", null, /*#__PURE__*/external_react_default.a.createElement("h3", null, " ", this.props.prompt, " "), /*#__PURE__*/external_react_default.a.createElement("br", null), /*#__PURE__*/external_react_default.a.createElement("textarea", {
        id: this.props.id,
        name: this.props.id,
...
/* harmony default export */ var components_Slide = (Slide_Slide);
// CONCATENATED MODULE: /home/djtran/Workspace/chunky-parrot/src/components/Sequence.js
...
function Sequence_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }




var Sequence_Sequence = /*#__PURE__*/function (_React$Component) {
  inherits_default()(Sequence, _React$Component);

  var _super = Sequence_createSuper(Sequence);

  function Sequence(props) {
    var _this;

    classCallCheck_default()(this, Sequence);

    _this = _super.call(this, props);
    _this.handleNext = _this.handleNext.bind(assertThisInitialized_default()(_this));
    _this.handleBack = _this.handleBack.bind(assertThisInitialized_default()(_this));
    _this.handleResponseData = _this.handleResponseData.bind(assertThisInitialized_default()(_this));
    _this.complete = _this.complete.bind(assertThisInitialized_default()(_this));
    _this.render = _this.render.bind(assertThisInitialized_default()(_this));
    _this.state = {
      index: 0,
      responses: [],
      result: ''
  ...
  createClass_default()(Sequence, [{
    key: "handleResponseData",
    value: function handleResponseData(event) {
      this.state.responses[this.state.index] = event.target.value; // this.responses[this.state.index] = event.target.value;
    }
  }, {
    key: "handleNext",
    value: function handleNext() {
      var current = this.state.index;
      var nextIndex = Math.min(this.state.index + 1, this.props.sequence.length - 1);
    ...
    value: function handleBack() {
      var backIndex = Math.max(this.state.index - 1, 0);
      this.setState({
        index: backIndex
      });
    }
    ...
    key: "render",
    value: function render() {
      var current = this.props.sequence[this.state.index];
      var resp = this.state.responses[this.state.index];
      ...
      return /*#__PURE__*/external_react_default.a.createElement("div", null, /*#__PURE__*/external_react_default.a.createElement(components_Slide, {
        key: current.id,
        prompt: current.prompt,
        response: resp,
        handleResponseData: this.handleResponseData
      }), /*#__PURE__*/external_react_default.a.createElement("br", null), "#", this.state.index + 1, " out of ", this.props.sequence.length, /*#__PURE__*/external_react_default.a.createElement("br", null), /*#__PURE__*/external_react_default.a.createElement("button", {
        onClick: this.handleBack
      }, "Back"), /*#__PURE__*/external_react_default.a.createElement("button", {
        onClick: this.handleNext
      }, "Next"), /*#__PURE__*/external_react_default.a.createElement("div", {
        id: "donedone"
      }, this.state.result));
    }
  }]);
...
/* harmony default export */ var components_Sequence = (Sequence_Sequence);
// CONCATENATED MODULE: /home/djtran/Workspace/chunky-parrot/src/containers/Workflow.js
...
function Workflow() {
  var _useRouteData = Object(external_react_static_["useRouteData"])(),
      workflow = _useRouteData.workflow;

  return /*#__PURE__*/external_react_default.a.createElement("div", null, /*#__PURE__*/external_react_default.a.createElement(Router["a" /* Link */], {
    to: "/index"
  }, '<', " Back"), /*#__PURE__*/external_react_default.a.createElement("br", null), /*#__PURE__*/external_react_default.a.createElement("h1", null, workflow.title), /*#__PURE__*/external_react_default.a.createElement(components_Sequence, {
    sequence: workflow.sequence
  }));
}

/* harmony default export */ var containers_Workflow = __webpack_exports__["default"] = (Workflow);
...
var t_2 = react_universal_component__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  id: "__react_static_root__/src/containers/Workflow",
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | __react_static_root__/src/containers/Workflow */).then(__webpack_require__.bind(null, 27))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
    return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname, '__react_static_root__/src/containers/Workflow');
  },
  resolve: function resolve() {
    return /*require.resolve*/(27);
  },
  chunkName: function chunkName() {
    return "__react_static_root__/src/containers/Workflow";
  }
}), universalOptions);
t_2.template = '__react_static_root__/src/containers/Workflow';
var t_3 = react_universal_component__WEBPACK_IMPORTED_MODULE_3___default()(babel_plugin_universal_import_universalImport__WEBPACK_IMPORTED_MODULE_1___default()({
  id: "__react_static_root__/src/containers/WorkflowIndex",
  load: function load() {
    return Promise.all([Promise.resolve(/* import() | __react_static_root__/src/containers/WorkflowIndex */).then(__webpack_require__.bind(null, 26))]).then(function (proms) {
      return proms[0];
    });
  },
  path: function path() {
    return path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname, '__react_static_root__/src/containers/WorkflowIndex');
  },
  resolve: function resolve() {
    return /*require.resolve*/(26);
  },
  chunkName: function chunkName() {
    return "__react_static_root__/src/containers/WorkflowIndex";
  }
}), universalOptions);
t_3.template = '__react_static_root__/src/containers/WorkflowIndex'; // Template Map
